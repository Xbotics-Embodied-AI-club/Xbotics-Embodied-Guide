...
| 模型 | 任务成功率 | 未见任务成功率 | 模型大小 | 适用场景 | 最新进展 |  
|------|------------|----------------|----------|----------|----------|  
| π₀ | 72.3% | 72.1% | 4.8B | 通用机器人 | 2024年发布 |  
| π₀.5 | 78.5% | 78.5% | 3.2B | 人形机器人 | 2025年10月 |  
| LLaDA-VLA | 76.8% | 78.5% | 4.1B | 通用机器人 | 2025年10月 |  
| VLA-Adapter | 74.2% | 75.6% | 1.8B | 小型机器人 | 2025年9月 |  
| GRAPE | 79.2% | 82.4% | 4.5B | 多任务泛化 | 2025年4月 |  
| ReWiND | 75.6% | 78.3% | 3.7B | 低样本学习 | 2025年6月 |  
| AutoDrive-R² | 81.7% | 85.3% | 5.2B | 自动驾驶 | 2025年9月 |  
...
### 5.3 触觉-视觉融合新数据集与框架汇总

---

#### 📌 V-HOP: 视觉-触觉多模态6D物体姿态跟踪数据集
**发布时间**: 2025-03-14  
**来源**: 布朗大学 & 德州大学达拉斯分校  
**论文链接**: [V-HOP Dataset](https://arxiv.org/abs/2502.17434)  
**技术框架**:  
- **多模态输入**: RGB-D图像 + 触觉传感器数据 + 机械手关节信息  
- **跨模态泛化**: 支持8种机械手、13种物体的跨设备泛化  
- **时间一致性**: 基于NVIDIA Isaac Sim模拟器生成序列数据  
**应用场景**:  
- 6D物体姿态跟踪  
- 复杂遮挡环境下的机器人操作  
- 强化学习中的跨设备策略迁移  
...
#### 🌟 ViTaM: 视觉-触觉联合记录与追踪系统
**发布时间**: 2024-11-26  
**来源**: 上海交通大学刘景全团队 & 卢策吾团队  
**论文链接**: [Nature Communications论文](https://www.nature.com/articles/s41467-024-53654-y)  
**技术框架**:  
- **硬件创新**:  
  - **柔性MEMS触觉手套**: 1152个力感知通道  
  - **应变干扰抑制**: 基于正/负拉阻效应的复合薄膜设计  
- **算法框架**:  
  - **多模态深度学习**: 联合视觉-触觉序列数据重建手-物状态  
  - **时空一致性建模**: 1.8cm平均重建误差（24种物体测试）  
**应用场景**:  
- 可形变物体交互建模  
- VLA（视觉-语言-动作）框架下的具身智能训练  
- 医疗机器人精细操作  


#### 🛠️ Embodied-AI-Guide 多模态数据集
**发布时间**: 2025-10-30  
**来源**: CSDN博客 & Lumina社区  
**项目地址**: [GitHub代码库](https://gitcode.com/gh_mirrors/em/Embodied-AI-Guide)  
**技术框架**:  
- **多模态数据采集**:  
  - **同步机制**: 硬件触发 + 软件时间戳对齐  
  - **传感器类型**: RGB-D相机 + 压阻/电容触觉阵列  
- **融合策略**:  
  - **早期/中期/晚期融合**: 支持不同层级的特征组合  
  - **预训练模型**: CLIP/DINOv2 + 触觉专用CNN/RNN  
**应用场景**:  
- 机器人抓取与材质识别  
- 强化学习中的多模态奖励建模  
- 工业质量检测（触觉纹理分析）  
...
#### 🧲 MagicGel: 视触觉-磁场融合传感器数据集
**发布时间**: 2025-10-28  
**来源**: IROS 2025论文  
**论文链接**: [IROS 2025论文](https://arxiv.org/html/2503.23345)  
**技术框架**:  
- **异构数据融合**:  
  - **磁触觉模态**: 霍尔传感器 + 强磁颗粒标记点  
  - **视觉-磁场关联**: 补偿光学形变特征缺失  
